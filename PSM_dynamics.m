...
rho = [1 1 2 1 1 1 0]; %types of joints: 1 for revolute, 0 for prismatic
dList=[0 0 q3-l_RCC l_tool 0 0 l_yaw2ctrlpnt];
alphaList=[pi/2 -pi/2 pi/2 0 -pi/2 -pi/2 -pi/2];
aList=[0 0 0 0 0 l_pitch2yaw 0];
tList=[q1+pi/2 q2-pi/2 0 q4 q5-pi/2 q6-pi/2 0];
